...
public class serate {
    ...
    static void help(int html) {
        ...
        System.err.println("  input puzzles.  If an --input=FILE option is specified then 36-character puzzle");
        System.err.println("  strings are read from that file, otherwise if 36-character puzzle operands are");
        ...
        System.err.println("        %g  The puzzle grid in 36-character [0-6] form.");
        ...
        System.err.println("      Read 36-character puzzle strings, one per line, from FILE.  By default");
        System.err.println("      operands are treated as 36-character puzzle strings.  If no operands are");
