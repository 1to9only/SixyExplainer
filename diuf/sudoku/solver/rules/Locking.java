...
public class Locking implements IndirectHintProducer {
    ...
    public void getHints(Grid grid, HintsAccumulator accu) throws InterruptedException {
        ...
        // Then Cage
        getHints(grid, Grid.Cage.class, Grid.Column.class, accu);
        getHints(grid, Grid.Cage.class, Grid.Row.class, accu);
        getHints(grid, Grid.Column.class, Grid.Cage.class, accu);
        getHints(grid, Grid.Row.class, Grid.Cage.class, accu);
    }
